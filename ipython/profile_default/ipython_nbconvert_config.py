...
# a config file.
# 
# - markdown2rst - ipython2python - path2url - ansi2html - highlight2latex -
# comment_lines - escape_latex - markdown2html - wrap_text - strip_files_prefix
# - filter_data_type - get_lines - ascii_only - markdown2latex - strip_ansi -
# add_prompts - ansi2latex - citation2latex - indent - html2text - strip_dollars
# - posix_path - highlight2html - add_anchor
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'svg', 'png', 'application/pdf', 'jpeg'}
